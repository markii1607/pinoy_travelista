...
.table{
 ...
 function readURL2(input) {
	...
	<?php $result=mysql_query("select * from itineraries where id='$get_id'")or die(mysql_error());
	$row=mysql_fetch_array($result);
	?>
	
	  <div class="content-wrapper">
<form action="updateItineraries.php"  method="post" enctype="multipart/form-data" >
      ...
      <div class="panel-body">
        ...
        <div class="tab-content">
         ...
         <table class="table" wpersonnel_idth="816" >
							  ...
							  <tr>
							<td colspan="8" ><strong><font>EDIT ITINERARY</font></strong></td>
				 ...
				 <td colspan="2" style="height:25px;font-size:12px;width:auto">Event Name:</td>
                    ...
                    <input type="text" name= "name" class="form-control" style="width:300px;"  value="<?php echo $row['event']; ?>" required>
		...
		<td colspan="2" style="height:25px;font-size:12px;width:auto">No. of Days:</td>
                    ...
                    <input type="text" name= "days" class="form-control" style="width:300px;"  value="<?php echo $row['day']; ?>" >
		...
		<td colspan="2" style="height:25px;font-size:12px;width:auto">Time:</td>
				...
				<div class="bootstrap-timepicker">
                    ...
                    <input type="text" name="time" class="form-control timepicker" value="<?php echo $row['time']; ?>" style="width:300px;" required>
