...
if(isset($_POST['post'])){
	...
	$package = $_POST['package'];
		...
		$sql=mysql_query("INSERT into itineraries(tour_package_id, day, time, event) VALUES ('$package', '$days','$time','$name')") or die(mysql_error());
		?>
		<script>
		alert('New Site Posted!');
		window.location.href='viewItiniraries.php?success';
        </script>
		<?php
?>
<?php
